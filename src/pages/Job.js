...
import {Table, Button, message, Radio, Tag, Badge, Popconfirm, Tooltip} from 'antd';
...
class Job extends React.Component {
    ...
    columns = [
        ...
        {
            // title: '抓取规则是否有效',
            title: <Tooltip placement="right" title="可以点击【测试】按钮对抓取规则有效性进行验证"> 抓取规则是否有效 <InfoCircleOutlined theme="twoTone"/></Tooltip>,
            key: 'patternStatus',
                ...
                <span>
                    <Radio.Group>
                        ...
                        <Radio.Button onClick={ () => {this.testPattern(record)} } >
                            {record.patternStatus === 3 && <LoadingOutlined style={{marginRight: 5}}/>}
                            测试
                        </Radio.Button>
                        <Popconfirm
                            title="真的要删掉我吗？"
