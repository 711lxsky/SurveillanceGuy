...
function EditJob() {
    ...
    useEffect(() => {
        ...
        if (location.state?.job) {
            ...
            form.setFieldsValue({
                name: location.state.job.name,
                cron: location.state.job.cron,
                url: location.state.job.url,
                pattern: location.state.job.pattern,
                email: location.state.job.email,
                content: location.state.job.content
            });
        }
    }, [location.state]);
    ...
    return (
        <div id="job-form">
            ...
            <Button onClick={onShowDrawer}>显示抽屉</Button>
